...
fn draw_reference_line(roads: Query<&Road>, mut gizmos: Gizmos<DebugGizmos>) {
    for road in &roads {
...
fn debug_heading(mut gizmos: Gizmos<DebugGizmos>, road: Query<&Road>) {
    for road in &road {
